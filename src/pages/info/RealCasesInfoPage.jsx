	...
	return (
		<div className="bg-black">
			...
			<div className="container flex flex-col items-center gap-5 mt-10">
				...
				<p>
					Lee los casos reales sobre ciberseguridad, mantenimiento, contraseñas y mas... en nuestros artículos y
					descubre la importancia de contar con una buena seguridad en tu dispositivo electrónico
				</p>
