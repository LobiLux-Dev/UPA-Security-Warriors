		...
		<div className="card bg-[#111111] w-96 shadow-xl text-white">
			<div className="card-body">
				...
				<div className="card-actions">
					<button className="btn btn-ghost text-[#FE3051]">Conocer más <BsArrowRight /> </button>
				</div>
			</div>
		</div>
	)
		...
		<section className='container h-screen flex flex-col items-center justify-center p-10 bg-black relative'>
			...
			<div className="grid grid-cols-3 mt-16 gap-5">
				<Card
					...
					description={"Es un sistema de seguridad informatica diseñada para proteger las computadoras o dispositivos electronicos de posibles ataques de softwares maliciosos."}
				/>

				<Card
					title={"Elije una contraseña segura"}
					description={"Las contraseñas seguras sirven para defenderte de ciberataques y reducir el riesgo de una vulneracion de seguridad y evita el robo de identidad."}
				/>

				<Card
					title={"Navegacion segura"}
					description={"Llega impedir que alguien acceda a informacion personal guardada como el historial de navegacion los datos que se usasn para autocompletar formularios entre otros."}
				/>
			</div>
