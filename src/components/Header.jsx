	...
	return (
		<header className="container grid grid-cols-2 bg-black h-header">
			<div className="flex flex-col justify-center p-10 gap-10">
				<h1 className="text-6xl">Somos expertos en tu <span className="text-[#FE3051]">seguridad</span></h1>
				<p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Magnam, amet laboriosam exercitationem ut quae recusandae labore. Qui atque quod, repellendus id molestiae at, a, pariatur hic iste debitis itaque ut?</p>
